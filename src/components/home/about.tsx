...
import { Body1, Body1Stronger, Card, Link, makeStyles, tokens, Subtitle1, shorthands, } from "@fluentui/react-components";
...
const About: React.FC<AboutProps> = ({ currentJob }) => {
    ...
    return (
        <Card appearance='subtle' className={styles.container} size="small">
            ...
            <Body1 as="p">
                <Body1Stronger>I&#x27;m Victor, a coffee-powered developer</Body1Stronger>.
            ...
            {currentJob && currentJob.company && <Body1 as="p">
                I&#x27;m currently working as a <Body1Stronger>{currentJob.title} at <Link as="a" inline href={currentJob.company?.url} target="_blank" rel="noreferrer noopener" className={styles.bold}>{currentJob.company?.name}</Link></Body1Stronger>, a {currentJob.company?.description} based in {currentJob.company?.location}.
