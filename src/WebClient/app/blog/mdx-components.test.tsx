...
describe('MdxA', () => {
  ...
  it('renders with empty string when href is undefined', () => {
    renderWithProviders(<MdxA>Link without href</MdxA>);
...
describe('MdxImg', () => {
  ...
  it('renders when src is undefined', () => {
    renderWithProviders(<MdxImg alt="Test image" />);
    expect(screen.getByAltText('Test image')).toBeInTheDocument();
  });

  it('renders when alt is undefined', () => {
    renderWithProviders(<MdxImg src="test.png" />);
    expect(screen.getByRole('presentation')).toBeInTheDocument();
  });

  it('renders when both src and alt are undefined', () => {
    const { container } = renderWithProviders(<MdxImg />);
